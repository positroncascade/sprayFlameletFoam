...
namespace Foam
{
    defineTypeNameAndDebug(NC12H26, 0);
    addToRunTimeSelectionTable(liquidProperties, NC12H26,);
    addToRunTimeSelectionTable(liquidProperties, NC12H26, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::NC12H26::NC12H26()
:
    liquidProperties
    (
        170.338,
...
Foam::NC12H26::NC12H26(const dictionary& dict)
:
    NC12H26()
{
...
void Foam::NC12H26::writeData(Ostream& os) const
{
...
Foam::Ostream& Foam::operator<<(Ostream& os, const NC12H26& l)
{
    l.writeData(os);
    return os;
}
